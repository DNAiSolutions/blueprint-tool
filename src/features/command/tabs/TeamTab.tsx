    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-12 flex justify-center">
        <div className="relative w-full max-w-md">
          ...
          <div className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.05] to-white/[0.01] p-6 backdrop-blur-xl">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-xl font-bold text-white">{TEAM_LEAD.name}</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
        {AGENTS.map((agent) => (
          <div
            key={agent.id}
            className="rounded-xl border border-white/5 bg-white/[0.02] p-4 hover:border-white/10 hover:bg-white/[0.04] transition-all"
          >
            ...
            <div className="flex flex-wrap gap-1">
              {agent.skills.slice(0, 3).map((s) => (
                <span key={s} className="text-[9px] px-1.5 py-0.5 rounded border border-white/5 bg-white/[0.03] text-slate-400">
                  {s}
                </span>
              ))}
