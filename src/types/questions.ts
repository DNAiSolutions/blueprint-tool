...
export const QUESTIONS: Question[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    question: 'What are you trying to grow? (Select all that apply)',
    type: 'multi-select',
    options: [
    ...
    required: true,
    allowCustom: true,
    coachingHint: "Start broad - understand their primary growth goals.",
  },
  {
    id: 'q2',
    section: 'goals-context',
  ...
  },
  {
    ...
    section: 'goals-context',
    sectionLabel: 'Goals & Context',
    question: "What's your biggest bottleneck right now? (Select all that apply)",
    type: 'multi-select',
    options: [
    ...
    required: true,
    allowCustom: true,
    coachingHint: "Identifying bottlenecks helps prioritize the fix.",
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    question: 'What type of conversion event happens? (Select all that apply)',
    type: 'multi-select',
    options: [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    question: 'What happens immediately after closing a deal? (Select all first steps)',
    type: 'multi-select',
    options: [
      ...
      { value: 'collect-payment', label: 'Collect Payment/Deposit', category: 'Financial' },
      { value: 'send-welcome', label: 'Send Welcome Packet', category: 'Communication' },
    ],
    required: false,
    allowCustom: true,
    dynamicFollowUp: true, // Triggers AI chain questions
    nodeCreation: {
      type: 'fulfillment',
      createPerSelection: true,
    },
    coachingHint: "Let's map what happens post-sale. We'll ask 'what's next' after each step.",
  },
  {
    id: 'q17',
    section: 'fulfillment',
  ...
  // Review method question (shown if q17 = yes)
  {
    id: 'q_review_method',
    section: 'fulfillment',
    sectionLabel: 'Reviews & Referrals',
    question: 'How do you ask for reviews? (Select all that apply)',
    type: 'multi-select',
    options: [
    ...
    coachingHint: "Structured review requests get 3x more reviews.",
  },
  // Referral program question (shown if q17 = yes)
  {
    id: 'q_referral_program',
    section: 'fulfillment',
    sectionLabel: 'Reviews & Referrals',
    question: 'Do you have a referral program? (Select all that apply)',
    type: 'multi-select',
    options: [
    ...
    allowCustom: true,
    skipCondition: (answers) => answers['q17']?.value === false,
    coachingHint: "Referrals are the highest-quality leads with best close rates.",
  },
