...
export const agents: Agent[] = [
  {
    ...
    status: 'online',
    avatar: 'C',
    skills: ['align-sales-system', 'blueprint-processing', 'pipeline-review', 'daily-briefing', 'forecast'],
  ...
  },
  {
    ...
    shortName: 'Content',
    role: 'Script & Video Production',
    status: 'busy',
    avatar: 'P',
    skills: ['content-production-system', 'timelapse-video', 'reel-scripting', 'heygen-render', 'batch-production'],
  ...
  },
  {
    ...
    status: 'online',
    avatar: 'S',
    skills: ['prospect', 'draft-outreach', 'call-prep', 'account-research', 'competitive-intelligence'],
