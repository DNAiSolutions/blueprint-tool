    ...
    <AppLayout>
      ...
      <div className="flex-1 overflow-auto p-6 space-y-4 scrollbar-thin">
        <div className="grid grid-cols-3 gap-4">
          <KPICard label="Current Package" value="Growth" subtitle="$1,297/mo — 2 channels" icon={CreditCard} />
          <KPICard label="Next Payment" value="May 1" subtitle="$1,297.00" icon={Calendar} />
